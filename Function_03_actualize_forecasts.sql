...
FROM
	fpa.fpa_actuals
WHERE
	EXTRACT(MONTH FROM fpa_actuals.accounting_period_end_date) <= 2 --Update month as needed
	AND EXTRACT(YEAR FROM fpa_actuals.accounting_period_end_date) = 2024; --Update year as needed
...
UPDATE
	fpa.forecasts_master_tbl
SET
	scenario = '2024 2+10' --Update scenario as needed or create a new one
WHERE
	scenario = 'Live';
...
FROM
	fpa.fpa_actuals
WHERE
	EXTRACT(MONTH FROM fpa_actuals.accounting_period_end_date) <= 3 --Update month as needed
	AND EXTRACT(YEAR FROM fpa_actuals.accounting_period_end_date) = 2024; --Update year as needed
...
UPDATE
	fpa.forecasts_master_tbl
SET
	scenario = '2024 3+9' --Update scenario as needed or create a new one
WHERE
	scenario = 'Live';
...
FROM
	fpa.fpa_actuals
WHERE
	EXTRACT(MONTH FROM fpa_actuals.accounting_period_end_date) <= 4 --Update month as needed
	AND EXTRACT(YEAR FROM fpa_actuals.accounting_period_end_date) = 2024; --Update year as needed
...
UPDATE
	fpa.forecasts_master_tbl
SET
	scenario = '2024 4+8' --Update scenario as needed or create a new one
WHERE
	scenario = 'Live';
...
FROM
	fpa.fpa_actuals
WHERE
	EXTRACT(MONTH FROM fpa_actuals.accounting_period_end_date) <= 5 --Update month as needed
	AND EXTRACT(YEAR FROM fpa_actuals.accounting_period_end_date) = 2024; --Update year as needed
...
UPDATE
	fpa.forecasts_master_tbl
SET
	scenario = '2024 5+7' --Update scenario as needed or create a new one
WHERE
	scenario = 'Live';

---- FOR THE NEXT MONTH, PASTE A BLOCK AND UPDATE NUMBERS 